...
- * MMU란 Memory Management Unit의 약자로 CPU에 탑재되어 가상 주소를 실제 메모리 주소로 변환해주는 하드웨어 장치이고 TLB는 Translation Lookaside Buffer의 약자로 자주 사용되는 가상 주소 -> 물리 주소 변환 정보를 저장하는 일종의 고속 캐시이다. </br>
